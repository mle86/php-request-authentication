...
abstract class Verifier
{
     ...
     * @return bool  True if the signature matches the message (and the instance's other settings, such as the signer's public key),
     *               False if not.
     ...
     * @param string $message    The raw message to be tested against the signature.
     * @param string $signature  The detached signature for the message.
     * @return void  Returns if the signature matches.
